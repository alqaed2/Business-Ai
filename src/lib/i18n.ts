...
const resources = {
  en: {
    translation: {
      ...
      "settings": {
        ...
        "profile_desc": "Update your personal details and how others see you.",
        ...
        "preferences_desc": "Configure how the AI OS interacts with you.",
        "email_notif": "Email Notifications",
        "email_notif_desc": "Receive weekly summaries of AI operations.",
        "dark_mode": "Dark Mode",
  ...
  ar: {
    translation: {
      ...
      "settings": {
        "subtitle": "إدارة حسابك وتفضيلاتك وتكوينات النظام.",
        ...
        "profile_desc": "قم بتحديث تفاصيلك الشخصية وكيف يراك الآخرون.",
        ...
        "preferences_desc": "تكوين كيفية تفاعل نظام الذكاء الاصطناعي معك.",
        "email_notif": "إشعارات البريد الإلكتروني",
        "email_notif_desc": "تلقي ملخصات أسبوعية لعمليات الذكاء الاصطناعي.",
        "dark_mode": "الوضع الليلي",
        "dark_mode_desc": "التبديل بين المظهر الفاتح والداكن.",
